  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src={logoImgPath} alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/ridhotadjudin"
            ...
            <li>
              <a
                href="https://www.instagram.com/ridhotadjudin"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.twitter.com/buayapalu"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">©2025 Ridho Tadjudin</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
